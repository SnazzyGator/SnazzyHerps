...
public class LeopardGeckoModel extends AnimatedGeoModel<LeopardGeckoEntity> {
    ...
    @Override
    public ResourceLocation getModelLocation(LeopardGeckoEntity object) {
        return new ResourceLocation(SnazzyHerps.MOD_ID, "geo/leopardgecko.geo.json");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(LeopardGeckoEntity animatable) {
        return new ResourceLocation(SnazzyHerps.MOD_ID, "animations/leopardgecko.animation.json");
    }

    @Override
    public void setLivingAnimations(LeopardGeckoEntity entity, Integer uniqueID, AnimationEvent customPredicate) {
