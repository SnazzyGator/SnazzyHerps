...
public class GoldenGeckoEntity extends TamableAnimal implements IAnimatable {
    ...
    public GoldenGeckoEntity(EntityType<? extends TamableAnimal> entityType, Level level) {
